...
.\nuget.exe install ScreenCapturer


# ダウンロードしたファイルをコピー
Copy-Item ".\ScreenCapturer.3.0.1\lib\netstandard2.0\ScreenCapturer.dll" -Destination ".\"
...
Copy-Item ".\System.Drawing.Common.7.0.0\lib\net462\System.Drawing.Common.dll" -Destination ".\"
